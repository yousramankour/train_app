...
class Direction {
  ...
  factory Direction.fromMap(Map<String, dynamic>map){
    ...
    return Direction(bounds: bounds, polylinePoints: PolylinePoints().decodePolyline(data['overview_polyline']['points']), TotalDistance: distance, TotalDuration: duration);
  }
}